...
def main():
    ...
    try:
        ...
        load_dotenv()
        #This may result in an error if the above setup of environment variable is not done 
    ...
    try:
        ...
        # Let's take a look at the JSON we'll send to the service        print(json.dumps(jsonBody, indent=2))
...
from dotenv import load_dotenv
import os
from azure.core.credentials import AzureKeyCredentialfrom azure.ai.textanalytics 
